...
const DashboardMahasiswa = () => {
	...
	return (
		<>
			...
			{isLoading ? (
				<div className="w-full h-96 flex justify-center items-center flex-col gap-3">
					<span className="loading loading-bars loading-lg"></span>
          <span className="italic">Sebentar mas, data-nya sedang kami jemput...</span>
          <button className="btn btn-outline btn-primary" onClick={() => window.location.reload()}>kalo belum bisa juga, coba tekan ini mas... 🤞🏻😅</button>
				</div>
			) : (
